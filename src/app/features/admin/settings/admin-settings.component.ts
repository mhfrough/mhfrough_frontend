...
type SettingsTab = 'profile' | 'security' | 'notifications' | 'ticker' | 'visitors' | 'widgets';
...
const VALID_TABS: SettingsTab[] = ['profile', 'security', 'notifications', 'ticker', 'visitors', 'widgets'];
